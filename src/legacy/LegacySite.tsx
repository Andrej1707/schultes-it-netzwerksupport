  ...
  return (
    <div className="legal-content privacy-content">
      ...
      <section>
        ...
        <p>
          Auf der Standortübersicht kannst du freiwillig die Funktion „Nächsten Standort finden“
          verwenden. Erst nach deiner Freigabe stellt dein Browser die ungefähren Koordinaten für
          die Berechnung bereit. Die Entfernung zu aktiven Schultes-IT-Standorten wird
          ausschließlich lokal in deinem Browser berechnet.
        </p>
        <p>
          Die Koordinaten werden dabei nicht an Schultes IT, Cloudflare, GitHub oder einen anderen
          Dienst übertragen und nicht gespeichert. Bei bereits erteilter Browser-Berechtigung kann
          die Standortseite die Berechnung automatisch erneut ausführen. Die Berechtigung kannst du
        ...
        <section className="service-detail-hero">
          ...
          >
            ...
            <dl>
              ...
              <div>
                <dt>Region</dt>
                <dd>{service.areaLabel ?? 'Deutschland / regional'}</dd>
              </div>
              <div>
                <dt>Modus</dt>
                <dd>{service.modeLabel ?? 'Bei dir / Remote'}</dd>
              </div>
            </dl>
            <footer>
...
export function MarketingApp() {
  ...
  useEffect(() => {
    ...
    document.body.dataset.locationPage = 'ludwigsburg'
    return () => {
      delete document.body.dataset.locationPage
    }
  }, [])
